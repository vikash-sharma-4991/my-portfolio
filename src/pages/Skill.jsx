...
import { FaJava, FaReact, FaNode, FaHtml5, FaCss3, FaBootstrap  } from "react-icons/fa";
import { SiMongodb, SiExpress, SiMysql, SiPostgresql, SiTailwindcss } from "react-icons/si";
...
return () => io.disconnect();
  ...
  return (
    <section ref={sectionRef} id='skills' className='h-1/2 w-full pb-8 flex flex-col items-center justify-center relative bg-black text-white overflow-hidden'>
      ...
      transition={{duration:0.5, delay:0.1}}>My Skills</motion.h2>


      <motion.p className='mt-2 mb-8 text-white/90 text-base sm:text-lg z-10'
      initial={{opacity:0, y:-10}}
      whileInView={{opacity:1, y:0}}
      transition={{duration:0.5, delay:0.1}}>Modern Application | Modern Technologies</motion.p>
